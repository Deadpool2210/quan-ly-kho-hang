// ====================================================================
// File : tienich.cpp
// Mo ta: Cai dat cac ham tien ich va thuat toan
// ====================================================================
#include <iostream>
#include <cstring>
#include "tienich.h"
...
// --------------------------------------------------------------------
// NHAP LIEU AN TOAN
// Y tuong: doc vao 1 dong, neu nguoi dung go sai (vd nhap chu thay vi so)
// thi bao loi va yeu cau nhap lai thay vi de chuong trinh treo.
// --------------------------------------------------------------------
...
// Tim "mau" co xuat hien trong "chuoi" khong (bo qua hoa/thuong).
// Tu cai dat thuat toan so khop tuan tu thay vi dung strstr.
...
// --------------------------------------------------------------------
// Selection sort tren mang chi so (khong dong cham toi du lieu goc).
// Sap theo gia tri khoa[]. tang = true -> tang dan.
...
// Tim kiem nhi phan theo ma tren mang chi so da duoc sap xep tang dan theo ma.
// Tra ve vi tri trong mang idx, -1 neu khong thay.
