// ====================================================================
// File : khohang.cpp
// Mo ta: Cai dat cac nghiep vu chinh cua he thong quan ly kho hang:
//        quan ly danh muc, nhap/xuat, tim kiem va bao cao thong ke.
// ====================================================================
#include <iostream>
#include <iomanip>
#include <fstream>
...
// --------------------------------------------------------------------
// KHOI TAO / GIAI PHONG
// Dung mang dong: khi day thi cap doi dung luong (giong cach vector lam
// nhung tu cai dat de tuan thu yeu cau de bai).
// --------------------------------------------------------------------
...
// Bao dam mang san pham con cho cho 1 phan tu moi
...
// --------------------------------------------------------------------
// PHAN TICH 1 DONG FILE THANH CAC TRUONG NGAN CACH BOI '|'
// Tra ve so truong doc duoc.
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// TIM KIEM THEO MA (tuyen tinh) - dung lai o nhieu nghiep vu khac
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// TIM KIEM SAN PHAM (theo ma chinh xac hoac ten gan dung)
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// SINH MA GIAO DICH TU DONG: GD + so thu tu 4 chu so
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// NGHIEP VU XUAT KHO (kiem tra ton kho truoc khi xuat)
// --------------------------------------------------------------------
void xuatKho(Kho& k) {
    char ma[MAX_MA];
    cout << "\n--- XUAT KHO ---\n";
...
// --------------------------------------------------------------------
// BAO CAO 1: CANH BAO HANG SAP HET
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// BAO CAO 2: NHAT KY NHAP/XUAT THEO THANG
// --------------------------------------------------------------------
...
// --------------------------------------------------------------------
// BAO CAO 3: THONG KE GIA TRI HANG TON KHO HIEN TAI
// Sap xep giam dan theo gia tri ton de de quan sat (dung selection sort
// tren mang chi so da tu cai dat trong tienich.cpp).
// --------------------------------------------------------------------
